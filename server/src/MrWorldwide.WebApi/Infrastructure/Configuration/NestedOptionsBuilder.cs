...
public class NestedOptionsBuilder
{
    ...
    {
        return _services.BindOptions<TOptions>($"{_configSectionRoot}:{configSectionName}", configureNestedOptions);
    }
    ...
    public OptionsBuilder<TOptions> BindNestedOptions<TOptions>(
        ...
        where TOptions: class
    {
        return _services.BindOptions<TOptions>($"{_configSectionRoot}:{ConfigurationUtility.ParseSectionName<TOptions>()}", configureNestedOptions);
    }
}