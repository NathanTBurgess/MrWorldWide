...
function NavigationDrawer() {
    ...
    const items: DrawerItem[] = [
        {icon: <HomeIcon/>, title: "Home", navigate: MrWorldWideRoutes.home}
    ]
    ...
    return (
        <Box display={"flex"} flexDirection={"column"} justifyContent={"space-between"} height={"100%"}>
                ...
                <ListItem sx={(theme)=>({
                    ...
                    <Button>
                        <Box component={"img"} src={"/drawer_banner.png"} width={"100%"}
                             onClick={() => navigate(MrWorldWideRoutes.home)}/>
                    </Button>
                </ListItem>
                <Divider/>
                {items.map((item) =>
            ...
            <List>
                <Divider/>
                <ListItem>
                    <ListItemButton onClick={() => navigate(MrWorldWideRoutes.login)}>
                        <ListItemIcon>
                            <LockPersonIcon/>
                        </ListItemIcon>
